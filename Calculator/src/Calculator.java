...
public class Calculator implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        frame.setTitle("Calculator By Ashbav");
        ...
        ChButton = new JButton("Clhis");
        ChButton.addActionListener(new ActionListener() {
                                       @Override
                                       public void actionPerformed(ActionEvent e) {
                                           Component[] components = historyP.getComponents();
                                           for (Component component : components){
                                               historyP.remove(component);
                                           }
                                           historyP.revalidate();
                                           historyP.repaint();
                                       }
...
//        historyP.setForeground(Color.black);
        ...
        ChButton.setBackground(new Color(201, 197, 183));
